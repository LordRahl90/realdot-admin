  ...
  >
    <div class="rounded-t mb-0 px-4 py-300 border-0">
      <div class="flex flex-wrap items-center">
        ...
        <div class="flex flex-none w-30">
          <router-link to="/company/create" class="bg-lightBlue-500 text-white py-2 px-4 rounded">
      ...
      <table class="items-center w-full bg-transparent border-collapse">
        ...
        <tbody>
          <tr v-for="c in companies" :key="c.id">
            ...
            >
              <button class="bg-pink-500 text-white active:bg-blue-600 font-bold uppercase text-xs px-4 py-2 rounded shadow hover:shadow-md outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">
...
export default {
  ...
  computed:{
    ...mapGetters({token:'getToken', companies:'getCompanies'})
  },
  props: {
    color: {
      default: "light",
